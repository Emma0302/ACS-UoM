...
public class BayesNetwork {
        ...
        try {
            ...
            switch (ini) {
                case 0://comparing score.
                    ...
                    break;
                case 1:// Best tree model.
                    Struct.GenerateBestTreeModel(exps.BuildEdges());
                    ComputeEPT(Struct, exps);
                    bestScore = scoring(Struct, exps);
                    break;
                case 2:// No Edge model.
                    Struct.GenerateNoEdgeModel();
                    ComputeEPT(Struct, exps);
                    bestScore = scoring(Struct, exps);
                    break;
                case 3:// Random Chain model.
                    Struct.GenerateRandomChainModel();
                    ComputeEPT(Struct, exps);
                    bestScore = scoring(Struct, exps);
                    break;
    ...
    public static void main(String[] args) throws Exception {
        /**
         * Please feel free to comment on code blew for testing.
         */
        //Log base 10.
        ...
        /**
         * Compare threshold and constant C
         * Please feel free to modify the variable C and threshold below.
         * Comparing strategy:
         * 1. Threshold is constant, change the C
         *
         */
        ...
        threshold = -41;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d1.txt",
                "result/ConstantCompare-bn-noMissingData-d1.txt", 0, true);
        C = 6;
        threshold = -115;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d2.txt",
                "result/ConstantCompare-bn-noMissingData-d2.txt", 0, true);
        C = 2;
        threshold = -9583;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d3.txt",
                "result/ConstantCompare-bn-noMissingData-d3.txt", 0, true);


        /**
         *
         * the result file starts with "noEdge" is no edge structure.
         * the result file starts with "rChain" is random chain structure.
        ...
        threshold = -41;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d1.txt",
                "result/noEdge-bn-noMissingData-d1.txt", 2, true);
        C = 5;
        threshold = -11;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d2.txt",
                "result/noEdge-bn-noMissingData-d2.txt", 2, true);
        C = 1;
        threshold = -961;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d3.txt",
                "result/noEdge-bn-noMissingData-d3.txt", 2, true);
        //For random chain.
        C = 5;
        threshold = -41;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d1.txt",
                "result/rChain-bn-noMissingData-d1.txt", 3, true);
        C = 5;
        threshold = -11;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d2.txt",
                "result/rChain-bn-noMissingData-d2.txt", 3, true);
        C = 1;
        threshold = -961;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d3.txt",
                "result/rChain-bn-noMissingData-d3.txt", 3, true);

        /**
         * the result file starts with "btree" is best tree model.
         * I set the same threshold and Constant C as it in with no edge and random chain.
         * I.e. for data set1 -> C = 5, threshold = -41;
         * for data set2 -> C = 5, threshold = -41
         * for data set3 -> C = 1, threshold = -961
         */
        ...
        threshold = -41;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d1.txt",
                "result/btree-bn-noMissingData-d1-b.txt", 1, true);
        C = 5;
        threshold = -11;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d2.txt",
                "result/btree-bn-noMissingData-d2-b.txt", 1, true);
        C = 1;
        threshold = -961;
        LearnStructureCPTFromNoMissingData("data/noMissingData-d3.txt",
                "result/btree-bn-noMissingData-d3-b.txt", 1, true);
